...
import irs.fdxtax640.jsonserializers.Tax1099NecSerializer;
import irs.fdxtax640.jsonserializers.TaxStatementListSerializer;
import irs.fdxtax640.map2objects.Map2Tax1099Nec;
import irs.fdxtax640.obj2mappers.TaxStatementList2Map;

import org.apache.commons.lang3.time.StopWatch;
import org.taxdataexchange.core.pdfbuilders.Tax1099NecPdfBuilder;
...
public class Tax1099NecDocumentGenerator {
    ...
    private void processOneRow(
        ...
        Tax1099Nec obj = Map2Tax1099Nec.generate( row );
        {
            String asJson = Tax1099NecSerializer.serialize( obj );
    ...
    private void processCsvForCompany(
        ...
        // CSV file
        String csvFileName  = "Tax1099Nec.csv";
        ...
        String outputFileName = "Tax1099Nec.rows.json";
    ...
    public static void main(String[] args) {
        ...
        Tax1099NecDocumentGenerator generator = new Tax1099NecDocumentGenerator( );
