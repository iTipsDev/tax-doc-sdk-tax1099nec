package org.taxdataexchange.usage.tax1099nec;

import org.taxdataexchange.core.utils.*;
import org.taxdataexchange.docs.tax1099nec.models.*;
import org.taxdataexchange.docs.tax1099nec.utils.*;

public class Tax1099NecDocumentGenerator {
    ...
    public static TaxDataList sampleData( ) {
        ...
        // Sample data
        // -----------------------------------------------------------------
        TaxData taxData = SampleData.sampleTaxData( "Tax1099Nec" );
    ...
    public static byte[] sampleQrAsPng( ) {
        ...
        Tax1099NecPdfBuilder pdfBuilder = new Tax1099NecPdfBuilder( );
        byte[] bytes = pdfBuilder.buildQr( taxDataList );

        String filePath = "samples/Tax1099Nec.qr.png";
    ...
    public static void samplePdf( ) {
        ...
        String filePath = "samples/Tax1099Nec.sample.pdf";
        FileUtils.bytesToFile( pdfBytes, filePath );
        System.out.println( filePath );

        String filePathPng = "samples/Tax1099Nec.sample.png";
    ...
    public static void addCoverPage() {
        ...
        String filePath2 = "samples/Tax1099Nec.cover.pdf";
        FileUtils.bytesToFile( combinedBytes, filePath2 );
    ...
    public static void insertQrCode() {
        ...
        String filePath2 = "samples/Tax1099Nec.inserted.pdf";
        FileUtils.bytesToFile( combinedBytes, filePath2 );
    ...
    public static void main(String[] args) {
        ...
        System.out.println( "Tax1099NecDocumentGenerator Begin" );
        ...
        System.out.println( "Tax1099NecDocumentGenerator Done" );
