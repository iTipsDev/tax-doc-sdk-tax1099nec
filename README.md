# tax-doc-sdk-tax1099nec

Software development kit to generate IRS Form 1099-NEC as PDF file using Financial Data Exchange (FDX) standards including QR codes and embedded JSON.

<img alt="Sample Form" src="samples/Tax1099Nec.sample.png" width="850"/>
